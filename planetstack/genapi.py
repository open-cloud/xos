...
class ServiceattributeSerializer(serializers.HyperlinkedModelSerializer):
	...
	services = serializers.HyperlinkedRelatedField(view_name='service-detail')
...
class InvoiceSerializer(serializers.HyperlinkedModelSerializer):
	...
	accounts = serializers.HyperlinkedRelatedField(view_name='account-detail')
...
class SliceprivilegeSerializer(serializers.HyperlinkedModelSerializer):
	...
	slices = serializers.HyperlinkedRelatedField(view_name='slice-detail')
	
	roles = serializers.HyperlinkedRelatedField(view_name='role-detail')
...
class NetworksliverSerializer(serializers.HyperlinkedModelSerializer):
	...
	networks = serializers.HyperlinkedRelatedField(view_name='network-detail')
...
class ChargeSerializer(serializers.HyperlinkedModelSerializer):
	...
	invoices = serializers.HyperlinkedRelatedField(view_name='invoice-detail')
...
class SliverSerializer(serializers.HyperlinkedModelSerializer):
	...
	images = serializers.HyperlinkedRelatedField(view_name='image-detail')
	
	slices = serializers.HyperlinkedRelatedField(view_name='slice-detail')
	
	nodes = serializers.HyperlinkedRelatedField(view_name='node-detail')
...
class NodeSerializer(serializers.HyperlinkedModelSerializer):
	...
	deployments = serializers.HyperlinkedRelatedField(view_name='deployment-detail')
...
class PlanetstackprivilegeSerializer(serializers.HyperlinkedModelSerializer):
	...
	planetstacks = serializers.HyperlinkedRelatedField(view_name='planetstack-detail')
...
class NetworkparameterList(generics.ListCreateAPIView):
    queryset = Networkparameter.objects.all()
...
class SliceroleList(generics.ListCreateAPIView):
    queryset = Slicerole.objects.all()
...
class PlanetstackroleList(generics.ListCreateAPIView):
    queryset = Planetstackrole.objects.all()
...
class NetworksliverList(generics.ListCreateAPIView):
    queryset = Networksliver.objects.all()
...
class UsableobjectList(generics.ListCreateAPIView):
    queryset = Usableobject.objects.all()
...
class ReservedresourceList(generics.ListCreateAPIView):
    queryset = Reservedresource.objects.all()
...
class PlanetstackprivilegeList(generics.ListCreateAPIView):
    queryset = Planetstackprivilege.objects.all()
...
class SingletonmodelList(generics.ListCreateAPIView):
    queryset = Singletonmodel.objects.all()
...
class PlanetstackList(generics.ListCreateAPIView):
    queryset = Planetstack.objects.all()
...
class NetworkparametertypeList(generics.ListCreateAPIView):
    queryset = Networkparametertype.objects.all()
...
class DeploymentprivilegeList(generics.ListCreateAPIView):
    queryset = Deploymentprivilege.objects.all()
...
class DeploymentroleList(generics.ListCreateAPIView):
    queryset = Deploymentrole.objects.all()
...
class PlcorebaseList(generics.ListCreateAPIView):
    queryset = Plcorebase.objects.all()
...
class NetworktemplateList(generics.ListCreateAPIView):
    queryset = Networktemplate.objects.all()
