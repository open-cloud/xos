...
cat >> $FN <<EOF
    VTN_ONOS_app:
      ...
      properties:
          install_dependencies: http://new-host:8080/repository/org/opencord/config/1.0-SNAPSHOT/config-1.0-SNAPSHOT.oar,http://new-host:8080/repository/org/opencord/vtn/1.0-SNAPSHOT/vtn-1.0-SNAPSHOT.oar
